        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CreditWallet_Available_Nonnegative", "\"AvailableCredits\" >= 0");
                    table.CheckConstraint("CK_CreditWallet_Reserved_Nonnegative", "\"ReservedCredits\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SourceImages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProjectId = table.Column<Guid>(type: "uuid", nullable: false),
                    SourceImageId = table.Column<Guid>(type: "uuid", nullable: false),
                    StylePresetId = table.Column<Guid>(type: "uuid", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RenderJobs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RenderJobs_StylePresets_StylePresetId",
                        column: x => x.StylePresetId,
                        principalTable: "StylePresets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RenderResults_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditTransactions_WalletId_CreatedAt",
                table: "CreditTransactions",
                columns: new[] { "WalletId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CreditTransactions_WalletId_IdempotencyKey",
                table: "CreditTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RenderJobs_StylePresetId",
                table: "RenderJobs",
                column: "StylePresetId");

            migrationBuilder.CreateIndex(
                name: "IX_RenderJobs_UserId_CreatedAt",
                table: "RenderJobs",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_RenderResults_RenderJobId",
                table: "RenderResults",
                column: "RenderJobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RenderResults_UserId",
                table: "RenderResults",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SourceImages_UserId",
                table: "SourceImages",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_StylePresets_Slug",
                table: "StylePresets",
                column: "Slug",
                unique: true);
        }
